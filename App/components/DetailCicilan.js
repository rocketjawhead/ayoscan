  ...
  <SafeAreaView style={{backgroundColor:'#F8F9F9'}}>
    ...
    <ScrollView>
      ...
      <View style={styles.body}>
            ...
            {/* <View style={{flex:0.7}}> */}
              <Text style={styles.txtTitleHead}>Detail Cicilan</Text>
            {/* </View> */}
            </View>
            ...
            props.valueListCicilan != '' && props.valueIdCicilan == '' ? 
              ...
              <View style={{flexDirection:'row',marginTop:heightPercentageToDP(1),marginBottom:heightPercentageToDP(1)}}>
                    ...
                    <View style={{flex:0.8}}>
                      ...
                      {props.valueTotalCicilan == props.valueAmount ?
                      <Text style={styles.txtAmountWallet}>Total Cicilan - {formatNumber(props.valueTotalCicilan)}</Text>
                      :
