  ...
  <ScrollView vertical={true}>
    <View style={ styles.header }>
      <View style={styles.col8}>
        <Text style={ styles.txtEmail }>Ubah Kata Sandi</Text>
      </View>
    ...
    <View style={{ marginTop:heightPercentageToDP(2)}}>
        <View style={ styles.contentInput }>
          <Text style={ styles.titleInput }>Kata Sandi Sebelumnya</Text>
        ...
        <View style={{ marginTop:heightPercentageToDP(2)}}>
        <View style={ styles.contentInput }>
          <Text style={ styles.titleInput }>Kata Sandi Baru</Text>
          <View style={{flexDirection:'row'}}>
          <View style={{flex:0.9}}>
            <TextInput 
              style={ styles.input } 
        ...
        <View style={{ marginTop:heightPercentageToDP(2)}}>
        <View style={ styles.contentInput }>
          <Text style={ styles.titleInput }>Konfirmasi Kata Sandi Baru</Text>
          <View style={{flexDirection:'row'}}>
          <View style={{flex:0.9}}>
          <TextInput 
            style={ styles.input } 
