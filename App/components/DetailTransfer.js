...
const DetailTransfer = props => (
  <SafeAreaView style={{backgroundColor:'#F8F9F9'}}>
    ...
    <ScrollView>
      ...
      {/* <Text style={styles.txtHeader}>Nominal1 Transaksi</Text>
      ...
      <View style={styles.body}>
            ...
            {/* <View style={{flex:0.7}}> */}
              <Text style={styles.txtTitleHead}>Detail Transfer</Text>
            {/* </View> */}
            </View>
            ...
            <View style={styles.fieldBox}>
            {props.valueListRekening == '' ? 
                <TouchableOpacity onPress={props.newRekening}>
                  <View style={{flexDirection:'row',marginTop:heightPercentageToDP(1),marginBottom:heightPercentageToDP(1)}}>
                    <View style={{flex:0.2}}>
              ...
              : 
            props.valueListRekening != '' && props.valueIdRekening == '' ? 
              <TouchableOpacity onPress={props.openRekening}>
                <View style={{flexDirection:'row',marginTop:heightPercentageToDP(1),marginBottom:heightPercentageToDP(1)}}>
                    <View style={{flex:0.2}}>
                      <IconAnt name="creditcard" style={ styles.iconCard } onPress={props.goBack}/>
                    </View>
                    <View style={{flex:0.8}}>
                      <Text style={styles.chooseRekening}>Pilih Rekening</Text>
                    </View>
                  </View>
              ...
              <View style={{flexDirection:'row',marginTop:heightPercentageToDP(1),marginBottom:heightPercentageToDP(1)}}>
                    ...
                    <View style={{flex:0.8}}>
                      ...
                      <Text style={styles.txtAmountWallet}>{props.valueNamaBank} | {props.valueNorek}</Text>
                    </View>
              </View>
              </TouchableOpacity>
            }
