  ...
  <ScrollView vertical={true}>
    <View style={ styles.header }>
      <View style={styles.col8}>
        <Text style={ styles.txtEmail }>Detail Notifikasi</Text>
      </View>
    ...
    <View style={{marginHorizontal:widthPercentageToDP(5),marginTop:heightPercentageToDP(3)}}>
        <Text style={{fontSize:heightPercentageToDP(3)}}>{props.valueTitle}</Text>

        <Text style={{fontSize:heightPercentageToDP(1.5)}}>{ props.getDate } { props.getMonth } { props.getYear }</Text>

        <Text style={{color:'#77869E',marginTop:heightPercentageToDP(2)}}>{props.valueDesc}</Text>
    </View>
