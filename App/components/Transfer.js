  ...
  <SafeAreaView style={{backgroundColor:'#F8F9F9'}}>
    ...
    <ScrollView>
      ...
      <View style={styles.body}>
            ...
            {/* <View style={{flex:0.7}}> */}
              <Text style={styles.txtTitleHead}>Transfer Bank</Text>
            {/* </View> */}
            </View>
            ...
            <View style={styles.fieldBox}>
                <TouchableOpacity onPress={props.openBank}>
                  <View style={{flexDirection:'row',marginTop:heightPercentageToDP(1),marginBottom:heightPercentageToDP(1)}}>
                    <View style={{flex:0.2}}>
                      <IconAnt name="creditcard" style={ styles.iconCard }/>
                    </View>
                    <View style={{flex:0.8}}>
                      {/* <Text style={styles.chooseRekening}>Tambah Rekening</Text> */}
                      {props.valueNamaBank == '' ?
                        <Text style={styles.chooseRekening}>Pilih Bank</Text>:   
                        <Text style={styles.chooseRekening}>{props.valueNamaBank}</Text> 
                      }
                    </View>
                  </View>
              </TouchableOpacity>
            ...
            <View>
              <View style={{flexDirection:'row',borderColor:'#D9D4D4',borderBottomWidth:1,marginHorizontal:heightPercentageToDP(3)}}>
                    <View style={{flex:0.8}}>
                    <TextInput 
                      placeholder="Nomor Rekening"
                      keyboardType = 'numeric'
                        style={ styles.inputRekening } 
                        onChangeText={ props.onChangeRekening } 
                        value={ props.valueRekening }
                        maxLength={50}
                      /> 
                    </View>
                    <View style={{flex:0.2}}>
                        <TouchableOpacity onPress={ props.saveIt } style={ styles.btnCheck } >
                          <Text style={ styles.txtLogin }>Check</Text>
                        </TouchableOpacity>
                    </View>
              </View>
            </View>
