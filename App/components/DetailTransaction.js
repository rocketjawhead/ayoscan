  ...
  <SafeAreaView style={{backgroundColor:'#F8F9F9'}}>
    ...
    <ScrollView>
      ...
      <View style={styles.headAmount}>
        <View style={{flex:0.7}}>
              <Text style={styles.txtTitleHead}>{props.valueTipeKategori == '1' ? 'Ubah Pemasukan' : 'Ubah Pengeluaran'}</Text>
            </View>
            <View style={{flex:0.3}}>
      ...
      <View style={styles.body}>
            ...
            {/* <View style={{flex:0.7}}> */}
              <Text style={styles.txtTitleHead}>Update {props.valueTipeKategori == '2' ? 'Pengeluaran' : 'Pemasukan'}</Text>
            {/* </View> */}
            </View>
            ...
            {/* end hr */}
              ...
              {/* <Text style={styles.txtDetailTransaction}>Detail Transaksi</Text> */}
                  ...
                  {/* <Text style={styles.txtChooseWallet}>Wallet Sebelumnya</Text>
                  <TextInput 
                    style={ styles.input } 
                    // onChangeText={ props.onChangeTitle } 
                    value={ props.valueWalletTrx.toUpperCase() }
                    maxLength={50}
                  /> */}
                  ...
                  <Text style={styles.txtChooseWallet}>Jumlah</Text>
                  <TextInput 
                  placeholder='0'
                  keyboardType={'numeric'}
                  value = { formatNumber(props.valueAmount) }
              ...
              <View style={{borderRadius:10,marginTop:heightPercentageToDP(1),marginLeft:widthPercentageToDP(5),marginRight:widthPercentageToDP(5)}}>
                <TouchableOpacity onPress={ props.saveIt } style={ styles.btnLogin } >
                  <Text style={ styles.txtLogin }>Simpan Perubahan</Text>
                </TouchableOpacity>
              </View>
              <View style={{borderRadius:10,marginTop:heightPercentageToDP(1),marginLeft:widthPercentageToDP(5),marginRight:widthPercentageToDP(5)}}>
