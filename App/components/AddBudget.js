  ...
  <ScrollView vertical={true}>
    <View style={ styles.header }>
      <View style={styles.col8}>
        <Text style={ styles.txtEmail }>Tambah Budget</Text>
...
alignSelf:'center'
        ...
        <View style={{flex:0.8,justifyContent:'center'}}>
            <Text style={{fontSize:heightPercentageToDP(2),color:'#4646446'}}>{props.valueIdCategory == '' ? 'Pilih Kategori' : props.valueTitleCategory} <IconAnt name="down" style={{fontSize:heightPercentageToDP(2),color:'#464646',
  }}/></Text>
        </View>
    </View>
    </TouchableOpacity> 
    ...
    {/* <Text style={{color:'#464646',
        fontFamily:'Avenir',
        marginTop:heightPercentageToDP(1.5),marginLeft:widthPercentageToDP(5)}}>Periode</Text> */}
