  ...
  <ScrollView vertical={true}>
    <View style={ styles.header }>
      <View style={styles.col8}>
        <Text style={ styles.txtEmail }>Poin</Text>
      </View>
    ...
    <View>
      ...
      <FlatList 
        ...
        // numColumns={2}
        data = { props.dataGift }
        renderItem = { props.renderItemGift }
        />
      </View>
    ...
    <View style={{backgroundColor:'#F2F2F2',
            ...
            marginTop:widthPercentageToDP(1),marginLeft:widthPercentageToDP(5),marginRight:widthPercentageToDP(5)}}></View>
            {/* end hr */}

    <View style={{marginHorizontal:widthPercentageToDP(5),marginTop:heightPercentageToDP(1)}}>
      <Text style={{fontSize:heightPercentageToDP(2)}}>History Poin</Text>
      <View style={{marginTop:heightPercentageToDP(1)}}>
      <FlatList 
        vertical={true}
        // numColumns={2}
        data = { props.dataPoin }
        renderItem = { props.renderItemPoin }
        />
      </View>
