...
const ValidationOtpRegister = props => (
    ...
    <ScrollView>
      <View style={ styles.container }>
        <View>
          ...
          <Text style={ styles.txtSlogan }>Periksa Email ({props.valueEmail}) untuk mendapatkan kode OTP</Text>
...
export default ValidationOtpRegister