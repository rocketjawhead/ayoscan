...
const AddCicilan = props => (
  <SafeAreaView style={{backgroundColor:'#ffffff', flex:1}}>
    { props.modalLoading == true ? <Loading /> : <View /> }
  <ScrollView vertical={true}>
    <View style={ styles.header }>
      <View style={styles.col8}>
        <Text style={ styles.txtEmail }>Tambah Daftar Cicilan</Text>
...
alignSelf:'center'
    ...
    <Text style={{textAlign:'center',fontSize:heightPercentageToDP(1.6)}}>Pilih Icon</Text>
        ...
        <View style={{flexDirection:'row'}}>
          <View style={{flex:0.5}}>
            <Text style={{color:'#464646',
            fontFamily:'Avenir',
            marginTop:heightPercentageToDP(1.5),marginLeft:widthPercentageToDP(5)}}>Tenor</Text>
            <TextInput 
                keyboardType={'numeric'}
                style={ styles.input2 } 
          ...
          <View style={{flex:0.5}}>
              <Text style={{color:'#464646',
              fontFamily:'Avenir',
              marginTop:heightPercentageToDP(1.5),marginLeft:widthPercentageToDP(5)}}>Tanggal Bayar</Text>
              <TextInput 
                  keyboardType={'numeric'}
                  style={ styles.input2 } 
                  onChangeText={ props.onChangeTglBayar } 
                  value={ props.valueTglBayar }
                  maxLength={50}
              />
          </View>
        </View>
        ...
        <Text style={{color:'#464646',
        fontFamily:'Avenir',
        marginTop:heightPercentageToDP(1.5),marginLeft:widthPercentageToDP(5)}}>Catatan</Text>
        <TextInput 
            placeholder="(Optional)"
            style={ styles.input2 } 
            onChangeText={ props.onChangeCatatan } 
            value={ props.valueCatatan }
            maxLength={50}
        />
    ...
    <View style={{borderRadius:10,marginTop:heightPercentageToDP(3),
      marginLeft:widthPercentageToDP(5),marginRight:widthPercentageToDP(5)}}>
                <TouchableOpacity onPress={ props.addCicilan } style={ styles.btnLogin } >
