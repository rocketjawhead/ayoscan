...
const CicilanAll = props => (
  <SafeAreaView style={{backgroundColor:'#ffffff', flex:1}}>
    { props.modalLoading == true ? <Loading /> : <View /> }
  <ScrollView vertical={true}>
    <View style={ styles.header }>
      <View style={styles.col8}>
        <Text style={ styles.txtEmail }>Cicilan</Text>
      </View>
    ...
    <TouchableOpacity onPress={props.addCicilan}>
    ...
    <View>
      ...
      <FlatList 
        vertical={true}
        // numColumns={2}
        data = { props.dataCicilan }
        renderItem = { props.renderItemCicilan }
        />
      </View>
