                ...
                <Text style={styles.txtBalance}>Poin</Text>
                  <View style={styles.boxAmount}>
                    ...
                    {/* <View style={{flexDirection:'row',flex:1}}>
                      <Image source={coin} style={styles.iconCoin }/>
                      <Text style={styles.txtCoin}>20000</Text>
                    </View> */}
                </View>
            </View>
            {/* <Text style={styles.txtBalance}>Balance</Text>
            <View style={styles.boxAmount}>
              <Text style={styles.txtIdr}>Rp </Text>
              <Text style={styles.txtAmount}>00000</Text>
            </View> */}
            
          </TouchableOpacity>

          {/* flatlist wallet disini */}

          <TouchableOpacity onPress={ props.toIncome } style={styles.addWallet}>
    ...
    <View style={styles.bodyHistory}>
        <View style={styles.headerColumn}>
            <View style={styles.col7}>
                <Text style={styles.txtHistory}>Transactions</Text>
            </View>
            <View style={styles.col3}>
                <Text style={styles.txtHistoryAll}>See All</Text>
            </View>
        </View>
    </View>
  </ScrollView>
