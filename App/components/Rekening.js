  ...
  <ScrollView vertical={true}>
    <View style={ styles.header }>
      <View style={styles.col8}>
        <Text style={ styles.txtEmail }>Daftar Rekening</Text>
      </View>
    ...
    <View style={{marginLeft:widthPercentageToDP(5),marginTop:heightPercentageToDP(2)}}>
    <TouchableOpacity onPress={props.addRekening}>
        <View style={{backgroundColor:'#13a699', borderRadius:5,width:'36%',height:heightPercentageToDP(3)}}>
        <Text style={{color:'#fff', textAlign:'center',fontSize:heightPercentageToDP(2)}}>Rekening Baru</Text>
        </View>
    </TouchableOpacity>
    </View>
    ...
    <View>
      ...
      <FlatList 
        vertical={true}
        // numColumns={2}
        data = { props.dataRekening }
        renderItem = { props.renderItemRekening }
        />
      </View>
