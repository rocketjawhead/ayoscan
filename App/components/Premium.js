  ...
  <ScrollView vertical={true}>
    <View style={ styles.header }>
      <View style={styles.col8}>
        <Text style={ styles.txtEmail }>Bukti Transaksi</Text>
      </View>
    ...
    {props.valueImage == '' ?
      ...
      :
      <TouchableOpacity onPress={props.selectImage}>
        <Image source={{uri :props.valueImage}} style={{
          height:heightPercentageToDP('30%'),
          width:widthPercentageToDP('90%'),
          // justifyContent:'center',
          alignContent:'center',
      ...
      <TouchableOpacity onPress={props.selectImage}>
      <Text style={{textAlign:'center',fontWeight:'bold',marginTop:heightPercentageToDP(1)}}>Pilih Bukti Transaksi</Text>
      </TouchableOpacity>
  ...
  <View style={{backgroundColor:'#F2F2F2',
        ...
        <TouchableOpacity onPress={props.openBank}>
          ...
          <View style={ styles.contentInput }>
            <Text style={ styles.titleInput }>Pilih Bank</Text>
            {props.valueNamaBank == '' ?
            <Text style={{fontSize:heightPercentageToDP(3),marginTop:heightPercentageToDP(1)}}>Silahkan Pilih Bank</Text>:   
            <Text style={{fontSize:heightPercentageToDP(3),marginTop:heightPercentageToDP(1)}}>{props.valueNamaBank}</Text> 
            }
          </View>
          </View>
        </TouchableOpacity>
        ...
        <TouchableOpacity onPress={props.openBankPremium}>
          <View style={{ marginTop:heightPercentageToDP(1)}}>
          <View style={ styles.contentInput }>
            <Text style={ styles.titleInput }>Pilih Bank Tujuan</Text>
            {props.valueNamaBankPremium == '' ?
            <Text style={{fontSize:heightPercentageToDP(3),marginTop:heightPercentageToDP(1)}}>Silahkan Pilih Bank Tujuan</Text>:   
            <Text style={{fontSize:heightPercentageToDP(3),marginTop:heightPercentageToDP(1)}}>{props.valueNamaBankPremium}</Text> 
            }
          </View>
          </View>
        </TouchableOpacity>
          ...
          <View style={ styles.contentInput }>
            <Text style={ styles.titleInput }>Nama Rekening Pengirim</Text>
            <TextInput 
              style={ styles.input } 
              onChangeText={ props.onChangeAccBank } 
              value={ props.valueAccBank }
              maxLength={50}
            />
          </View>
          </View>
          ...
          <View style={{ marginTop:heightPercentageToDP(1)}}>
        <View >
          <Text style={ styles.titleInput }>Tanggal Transaksi</Text>
          <DatePicker
      ...
      marginLeft:widthPercentageToDP(5),marginRight:widthPercentageToDP(5)}}>
                <TouchableOpacity onPress={ props.upload } style={ styles.btnLogin } >
