...
const ListMessage = props => (
  <TouchableOpacity onPress={props.toDetailMessage}>
    ...
    <View style={ styles.WrapperHistory }>
        <View style={{flexDirection:'row'}}>
          ...
          <View style={{flex:0.7,justifyContent:'center',marginRight:widthPercentageToDP(2)}}>
            <Text style={ props.isRead == '1' ? styles.txtTitleHistoryRead : styles.txtTitleHistory }>{props.title }</Text>
            <Text style={ styles.txtTime }>{ props.desc_message }</Text>
          </View>

          <View style={{flex:0.3,justifyContent:'center',marginRight:widthPercentageToDP(2)}}>
            <Text style={ styles.txtTimeMessage }>{ props.getDate } { props.getMonth } { props.getYear }</Text>
          </View>
