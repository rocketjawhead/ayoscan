...
import ValidationOtpPin from '../components/ValidationOtpPin'
import { URL_API,SECRET_KEY } from '../env'

class ValidationOtpPinContainer extends Component{
  ...
  async _validationOtp(code)
  {
    ...
    const response = await fetch(`${URL_API}User/validationOtp`, {
        ...
        if(dataRes.ResponCode == '00'){
          this.props.navigation.navigate('ResetPinContainer',dataRes.Data)
        }else{
...
export default ValidationOtpPinContainer
