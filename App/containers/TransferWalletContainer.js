...
class TransferWalletContainer extends Component{
  ...
  async saveIt(){
    ...
    const response = await fetch(`${URL_API}Transaksi/createTrf`, {
        method: "POST",
        headers: {
    ...
    // console.log(this.state)
     return (
      ...
      modalLoading={ this.state.loading }
        ...
        onChangeWallet = { (wallet) => this.setState({wallet}) }
...
export default connect(mapStateToProps, mapDispatchToProps)(TransferWalletContainer)