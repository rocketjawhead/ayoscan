...
const ModalTypeTransaction = props => (
  <Modal
    animationType="fade"
    visible={props.modalVisibleTypeTransaction}
  >
    ...
    <View style={{flexDirection:'row'}}>
          <View style={{flex:0.5}}>
              <Text style={{
                ...
                }}>Pilih Transaksi</Text>
          </View>
          <View style={{flex:0.5}}>
              <TouchableOpacity onPress={ props.closeTypeTransaction }>
      ...
      <View style={ styles.MainWrapper }>
        { props.renderListTypeTransaction }
      </View>
    </View>
  </Modal>
)
