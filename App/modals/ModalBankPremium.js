...
const ModalBankPremium = props => (
  <Modal
    animationType="fade"
    visible={props.modalVisibleBankPremium}
  >
    ...
    <View style={{flexDirection:'row'}}>
          ...
          <View style={{flex:0.5}}>
              <TouchableOpacity onPress={ props.closeBankPremium }>
...
export default ModalBankPremium