...
const ModalRekening = props => (
  <Modal
    animationType="fade"
    visible={props.modalVisibleRekening}
  >
    ...
    <View style={{flexDirection:'row'}}>
          ...
          <View style={{flex:0.5}}>
              <TouchableOpacity onPress={ props.closeRekening }>
    ...
    {/* <Text style={{
      ...
      color:'#3827B4'
      }} onPress={props.newRekening}>+ Rekening Baru</Text> */}

      <View style={ styles.MainWrapper }>
        { props.renderListRekening }
      </View>
    </View>
  </Modal>
)
