...
const ModalIcon = props => (
  <Modal
    animationType="fade"
    visible={props.modalVisibleIcon}
  >
    <SafeAreaView style={ styles.SafeArea }/>
    <View style={{marginBottom: heightPercentageToDP(5)}}>
    
    <View style={{flexDirection:'row',marginBottom: heightPercentageToDP(5)}}>
          <View style={{flex:0.5}}>
              <Text style={{
          ...
          <View style={{flex:0.5}}>
              <TouchableOpacity onPress={ props.closeIcon }>
